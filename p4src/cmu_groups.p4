                               ...
                               inout ingress_metadata_t meta )
{
    ...
    Register<bit<16>, bit<16>>(65536, 0) cmu1_buckets; 
    ...
    action op_cmu1_cond_add(){
        meta.cmu_group1.cmu1.param2 = cmu1_op_cond_add.execute((bit<16>)meta.cmu_group1.cmu1.key[15:0]);
    }
    action op_cmu1_and_or(){
        meta.cmu_group1.cmu1.param2 = cmu1_op_and_or.execute((bit<16>)meta.cmu_group1.cmu1.key[15:0]);
    }
    action op_cmu1_max(){
        meta.cmu_group1.cmu1.param2 = cmu1_op_max.execute((bit<16>)meta.cmu_group1.cmu1.key[15:0]);
    }

    //action op_cmu1_reserved(){
    //    meta.cmu_group1.cmu1.param2 = cmu1_op_reserved.execute((bit<16>)meta.cmu_group1.cmu1.key[15:0]);
    //}
    ...
    Register<bit<16>, bit<16>>(65536, 0) cmu2_buckets; 
    ...
    action op_cmu2_cond_add(){
        meta.cmu_group1.cmu2.param2 = cmu2_op_cond_add.execute((bit<16>)meta.cmu_group1.cmu2.key[15:0]);
    }
    action op_cmu2_and_or(){
        meta.cmu_group1.cmu2.param2 = cmu2_op_and_or.execute((bit<16>)meta.cmu_group1.cmu2.key[15:0]);
    }
    action op_cmu2_max(){
        meta.cmu_group1.cmu2.param2 = cmu2_op_max.execute((bit<16>)meta.cmu_group1.cmu2.key[15:0]);
    }

    //action op_cmu2_reserved(){
    //    meta.cmu_group1.cmu2.param2 = cmu2_op_reserved.execute((bit<16>)meta.cmu_group1.cmu2.key[15:0]);
    //}
    ...
    Register<bit<16>, bit<16>>(65536, 0) cmu3_buckets; 
    ...
    action op_cmu3_cond_add(){
        meta.cmu_group1.cmu3.param2 = cmu3_op_cond_add.execute((bit<16>)meta.cmu_group1.cmu3.key[15:0]);
    }
    action op_cmu3_and_or(){
        meta.cmu_group1.cmu3.param2 = cmu3_op_and_or.execute((bit<16>)meta.cmu_group1.cmu3.key[15:0]);
    }
    action op_cmu3_max(){
        meta.cmu_group1.cmu3.param2 = cmu3_op_max.execute((bit<16>)meta.cmu_group1.cmu3.key[15:0]);
    }

    //action op_cmu3_reserved(){
    //    meta.cmu_group1.cmu3.param2 = cmu3_op_reserved.execute((bit<16>)meta.cmu_group1.cmu3.key[15:0]);
    //}
                               ...
                               inout ingress_metadata_t meta )
{
    ...
    action op_cmu1_cond_add(){
        meta.cmu_group2.cmu1.param2 = cmu1_op_cond_add.execute((bit<16>)meta.cmu_group2.cmu1.key[15:0]);
    }
    action op_cmu1_and_or(){
        meta.cmu_group2.cmu1.param2 = cmu1_op_and_or.execute((bit<16>)meta.cmu_group2.cmu1.key[15:0]);
    }
    action op_cmu1_max(){
        meta.cmu_group2.cmu1.param2 = cmu1_op_max.execute((bit<16>)meta.cmu_group2.cmu1.key[15:0]);
    }

    //action op_cmu1_reserved(){
    //    meta.cmu_group2.cmu1.param2 = cmu1_op_reserved.execute((bit<16>)meta.cmu_group2.cmu1.key[15:0]);
    //}
    ...
    action op_cmu2_cond_add(){
        meta.cmu_group2.cmu2.param2 = cmu2_op_cond_add.execute((bit<16>)meta.cmu_group2.cmu2.key[15:0]);
    }
    action op_cmu2_and_or(){
        meta.cmu_group2.cmu2.param2 = cmu2_op_and_or.execute((bit<16>)meta.cmu_group2.cmu2.key[15:0]);
    }
    action op_cmu2_max(){
        meta.cmu_group2.cmu2.param2 = cmu2_op_max.execute((bit<16>)meta.cmu_group2.cmu2.key[15:0]);
    }

    //action op_cmu2_reserved(){
    //    meta.cmu_group2.cmu2.param2 = cmu2_op_reserved.execute((bit<16>)meta.cmu_group2.cmu2.key[15:0]);
    //}
    ...
    action op_cmu3_cond_add(){
        meta.cmu_group2.cmu3.param2 = cmu3_op_cond_add.execute((bit<16>)meta.cmu_group2.cmu3.key[15:0]);
    }
    action op_cmu3_and_or(){
        meta.cmu_group2.cmu3.param2 = cmu3_op_and_or.execute((bit<16>)meta.cmu_group2.cmu3.key[15:0]);
    }
    action op_cmu3_max(){
        meta.cmu_group2.cmu3.param2 = cmu3_op_max.execute((bit<16>)meta.cmu_group2.cmu3.key[15:0]);
    }

    //action op_cmu3_reserved(){
    //    meta.cmu_group2.cmu3.param2 = cmu3_op_reserved.execute((bit<16>)meta.cmu_group2.cmu3.key[15:0]);
    //}
                               ...
                               inout ingress_metadata_t meta )
{
    ...
    action op_cmu1_cond_add(){
        meta.cmu_group3.cmu1.param2 = cmu1_op_cond_add.execute((bit<16>)meta.cmu_group3.cmu1.key[15:0]);
    }
    action op_cmu1_and_or(){
        meta.cmu_group3.cmu1.param2 = cmu1_op_and_or.execute((bit<16>)meta.cmu_group3.cmu1.key[15:0]);
    }
    action op_cmu1_max(){
        meta.cmu_group3.cmu1.param2 = cmu1_op_max.execute((bit<16>)meta.cmu_group3.cmu1.key[15:0]);
    }

    //action op_cmu1_reserved(){
    //    meta.cmu_group3.cmu1.param2 = cmu1_op_reserved.execute((bit<16>)meta.cmu_group3.cmu1.key[15:0]);
    //}
    ...
    action op_cmu2_cond_add(){
        meta.cmu_group3.cmu2.param2 = cmu2_op_cond_add.execute((bit<16>)meta.cmu_group3.cmu2.key[15:0]);
    }
    action op_cmu2_and_or(){
        meta.cmu_group3.cmu2.param2 = cmu2_op_and_or.execute((bit<16>)meta.cmu_group3.cmu2.key[15:0]);
    }
    action op_cmu2_max(){
        meta.cmu_group3.cmu2.param2 = cmu2_op_max.execute((bit<16>)meta.cmu_group3.cmu2.key[15:0]);
    }

    //action op_cmu2_reserved(){
    //    meta.cmu_group3.cmu2.param2 = cmu2_op_reserved.execute((bit<16>)meta.cmu_group3.cmu2.key[15:0]);
    //}
    ...
    action op_cmu3_cond_add(){
        meta.cmu_group3.cmu3.param2 = cmu3_op_cond_add.execute((bit<16>)meta.cmu_group3.cmu3.key[15:0]);
    }
    action op_cmu3_and_or(){
        meta.cmu_group3.cmu3.param2 = cmu3_op_and_or.execute((bit<16>)meta.cmu_group3.cmu3.key[15:0]);
    }
    action op_cmu3_max(){
        meta.cmu_group3.cmu3.param2 = cmu3_op_max.execute((bit<16>)meta.cmu_group3.cmu3.key[15:0]);
    }

    //action op_cmu3_reserved(){
    //    meta.cmu_group3.cmu3.param2 = cmu3_op_reserved.execute((bit<16>)meta.cmu_group3.cmu3.key[15:0]);
    //}
                               ...
                               inout ingress_metadata_t meta )
{
    ...
    action op_cmu1_cond_add(){
        meta.cmu_group4.cmu1.param2 = cmu1_op_cond_add.execute((bit<16>)meta.cmu_group4.cmu1.key[15:0]);
    }
    action op_cmu1_and_or(){
        meta.cmu_group4.cmu1.param2 = cmu1_op_and_or.execute((bit<16>)meta.cmu_group4.cmu1.key[15:0]);
    }
    action op_cmu1_max(){
        meta.cmu_group4.cmu1.param2 = cmu1_op_max.execute((bit<16>)meta.cmu_group4.cmu1.key[15:0]);
    }

    //action op_cmu1_reserved(){
    //    meta.cmu_group4.cmu1.param2 = cmu1_op_reserved.execute((bit<16>)meta.cmu_group4.cmu1.key[15:0]);
    //}
    ...
    action op_cmu2_cond_add(){
        meta.cmu_group4.cmu2.param2 = cmu2_op_cond_add.execute((bit<16>)meta.cmu_group4.cmu2.key[15:0]);
    }
    action op_cmu2_and_or(){
        meta.cmu_group4.cmu2.param2 = cmu2_op_and_or.execute((bit<16>)meta.cmu_group4.cmu2.key[15:0]);
    }
    action op_cmu2_max(){
        meta.cmu_group4.cmu2.param2 = cmu2_op_max.execute((bit<16>)meta.cmu_group4.cmu2.key[15:0]);
    }

    //action op_cmu2_reserved(){
    //    meta.cmu_group4.cmu2.param2 = cmu2_op_reserved.execute((bit<16>)meta.cmu_group4.cmu2.key[15:0]);
    //}
    ...
    action op_cmu3_cond_add(){
        meta.cmu_group4.cmu3.param2 = cmu3_op_cond_add.execute((bit<16>)meta.cmu_group4.cmu3.key[15:0]);
    }
    action op_cmu3_and_or(){
        meta.cmu_group4.cmu3.param2 = cmu3_op_and_or.execute((bit<16>)meta.cmu_group4.cmu3.key[15:0]);
    }
    action op_cmu3_max(){
        meta.cmu_group4.cmu3.param2 = cmu3_op_max.execute((bit<16>)meta.cmu_group4.cmu3.key[15:0]);
    }

    //action op_cmu3_reserved(){
    //    meta.cmu_group4.cmu3.param2 = cmu3_op_reserved.execute((bit<16>)meta.cmu_group4.cmu3.key[15:0]);
    //}
                               ...
                               inout egress_metadata_t meta )
{
    ...
    action op_cmu1_cond_add(){
        meta.cmu_group5.cmu1.param2 = cmu1_op_cond_add.execute((bit<16>)meta.cmu_group5.cmu1.key[15:0]);
    }
    action op_cmu1_and_or(){
        meta.cmu_group5.cmu1.param2 = cmu1_op_and_or.execute((bit<16>)meta.cmu_group5.cmu1.key[15:0]);
    }
    action op_cmu1_max(){
        meta.cmu_group5.cmu1.param2 = cmu1_op_max.execute((bit<16>)meta.cmu_group5.cmu1.key[15:0]);
    }

    //action op_cmu1_reserved(){
    //    meta.cmu_group5.cmu1.param2 = cmu1_op_reserved.execute((bit<16>)meta.cmu_group5.cmu1.key[15:0]);
    //}
    ...
    action op_cmu2_cond_add(){
        meta.cmu_group5.cmu2.param2 = cmu2_op_cond_add.execute((bit<16>)meta.cmu_group5.cmu2.key[15:0]);
    }
    action op_cmu2_and_or(){
        meta.cmu_group5.cmu2.param2 = cmu2_op_and_or.execute((bit<16>)meta.cmu_group5.cmu2.key[15:0]);
    }
    action op_cmu2_max(){
        meta.cmu_group5.cmu2.param2 = cmu2_op_max.execute((bit<16>)meta.cmu_group5.cmu2.key[15:0]);
    }

    //action op_cmu2_reserved(){
    //    meta.cmu_group5.cmu2.param2 = cmu2_op_reserved.execute((bit<16>)meta.cmu_group5.cmu2.key[15:0]);
    //}
    ...
    action op_cmu3_cond_add(){
        meta.cmu_group5.cmu3.param2 = cmu3_op_cond_add.execute((bit<16>)meta.cmu_group5.cmu3.key[15:0]);
    }
    action op_cmu3_and_or(){
        meta.cmu_group5.cmu3.param2 = cmu3_op_and_or.execute((bit<16>)meta.cmu_group5.cmu3.key[15:0]);
    }
    action op_cmu3_max(){
        meta.cmu_group5.cmu3.param2 = cmu3_op_max.execute((bit<16>)meta.cmu_group5.cmu3.key[15:0]);
    }

    //action op_cmu3_reserved(){
    //    meta.cmu_group5.cmu3.param2 = cmu3_op_reserved.execute((bit<16>)meta.cmu_group5.cmu3.key[15:0]);
    //}
                               ...
                               inout egress_metadata_t meta )
{
    ...
    action op_cmu1_cond_add(){
        meta.cmu_group6.cmu1.param2 = cmu1_op_cond_add.execute((bit<16>)meta.cmu_group6.cmu1.key[15:0]);
    }
    action op_cmu1_and_or(){
        meta.cmu_group6.cmu1.param2 = cmu1_op_and_or.execute((bit<16>)meta.cmu_group6.cmu1.key[15:0]);
    }
    action op_cmu1_max(){
        meta.cmu_group6.cmu1.param2 = cmu1_op_max.execute((bit<16>)meta.cmu_group6.cmu1.key[15:0]);
    }

    //action op_cmu1_reserved(){
    //    meta.cmu_group6.cmu1.param2 = cmu1_op_reserved.execute((bit<16>)meta.cmu_group6.cmu1.key[15:0]);
    //}
    ...
    action op_cmu2_cond_add(){
        meta.cmu_group6.cmu2.param2 = cmu2_op_cond_add.execute((bit<16>)meta.cmu_group6.cmu2.key[15:0]);
    }
    action op_cmu2_and_or(){
        meta.cmu_group6.cmu2.param2 = cmu2_op_and_or.execute((bit<16>)meta.cmu_group6.cmu2.key[15:0]);
    }
    action op_cmu2_max(){
        meta.cmu_group6.cmu2.param2 = cmu2_op_max.execute((bit<16>)meta.cmu_group6.cmu2.key[15:0]);
    }

    //action op_cmu2_reserved(){
    //    meta.cmu_group6.cmu2.param2 = cmu2_op_reserved.execute((bit<16>)meta.cmu_group6.cmu2.key[15:0]);
    //}
    ...
    action op_cmu3_cond_add(){
        meta.cmu_group6.cmu3.param2 = cmu3_op_cond_add.execute((bit<16>)meta.cmu_group6.cmu3.key[15:0]);
    }
    action op_cmu3_and_or(){
        meta.cmu_group6.cmu3.param2 = cmu3_op_and_or.execute((bit<16>)meta.cmu_group6.cmu3.key[15:0]);
    }
    action op_cmu3_max(){
        meta.cmu_group6.cmu3.param2 = cmu3_op_max.execute((bit<16>)meta.cmu_group6.cmu3.key[15:0]);
    }

    //action op_cmu3_reserved(){
    //    meta.cmu_group6.cmu3.param2 = cmu3_op_reserved.execute((bit<16>)meta.cmu_group6.cmu3.key[15:0]);
    //}
                               ...
                               inout egress_metadata_t meta )
{
    ...
    action op_cmu1_cond_add(){
        meta.cmu_group7.cmu1.param2 = cmu1_op_cond_add.execute((bit<16>)meta.cmu_group7.cmu1.key[15:0]);
    }
    action op_cmu1_and_or(){
        meta.cmu_group7.cmu1.param2 = cmu1_op_and_or.execute((bit<16>)meta.cmu_group7.cmu1.key[15:0]);
    }
    action op_cmu1_max(){
        meta.cmu_group7.cmu1.param2 = cmu1_op_max.execute((bit<16>)meta.cmu_group7.cmu1.key[15:0]);
    }

    //action op_cmu1_reserved(){
    //    meta.cmu_group7.cmu1.param2 = cmu1_op_reserved.execute((bit<16>)meta.cmu_group7.cmu1.key[15:0]);
    //}
    ...
    action op_cmu2_cond_add(){
        meta.cmu_group7.cmu2.param2 = cmu2_op_cond_add.execute((bit<16>)meta.cmu_group7.cmu2.key[15:0]);
    }
    action op_cmu2_and_or(){
        meta.cmu_group7.cmu2.param2 = cmu2_op_and_or.execute((bit<16>)meta.cmu_group7.cmu2.key[15:0]);
    }
    action op_cmu2_max(){
        meta.cmu_group7.cmu2.param2 = cmu2_op_max.execute((bit<16>)meta.cmu_group7.cmu2.key[15:0]);
    }

    //action op_cmu2_reserved(){
    //    meta.cmu_group7.cmu2.param2 = cmu2_op_reserved.execute((bit<16>)meta.cmu_group7.cmu2.key[15:0]);
    //}
    ...
    action op_cmu3_cond_add(){
        meta.cmu_group7.cmu3.param2 = cmu3_op_cond_add.execute((bit<16>)meta.cmu_group7.cmu3.key[15:0]);
    }
    action op_cmu3_and_or(){
        meta.cmu_group7.cmu3.param2 = cmu3_op_and_or.execute((bit<16>)meta.cmu_group7.cmu3.key[15:0]);
    }
    action op_cmu3_max(){
        meta.cmu_group7.cmu3.param2 = cmu3_op_max.execute((bit<16>)meta.cmu_group7.cmu3.key[15:0]);
    }

    //action op_cmu3_reserved(){
    //    meta.cmu_group7.cmu3.param2 = cmu3_op_reserved.execute((bit<16>)meta.cmu_group7.cmu3.key[15:0]);
    //}
                               ...
                               inout egress_metadata_t meta )
{
    ...
    action op_cmu1_cond_add(){
        meta.cmu_group8.cmu1.param2 = cmu1_op_cond_add.execute((bit<16>)meta.cmu_group8.cmu1.key[15:0]);
    }
    action op_cmu1_and_or(){
        meta.cmu_group8.cmu1.param2 = cmu1_op_and_or.execute((bit<16>)meta.cmu_group8.cmu1.key[15:0]);
    }
    action op_cmu1_max(){
        meta.cmu_group8.cmu1.param2 = cmu1_op_max.execute((bit<16>)meta.cmu_group8.cmu1.key[15:0]);
    }

    //action op_cmu1_reserved(){
    //    meta.cmu_group8.cmu1.param2 = cmu1_op_reserved.execute((bit<16>)meta.cmu_group8.cmu1.key[15:0]);
    //}
    ...
    action op_cmu2_cond_add(){
        meta.cmu_group8.cmu2.param2 = cmu2_op_cond_add.execute((bit<16>)meta.cmu_group8.cmu2.key[15:0]);
    }
    action op_cmu2_and_or(){
        meta.cmu_group8.cmu2.param2 = cmu2_op_and_or.execute((bit<16>)meta.cmu_group8.cmu2.key[15:0]);
    }
    action op_cmu2_max(){
        meta.cmu_group8.cmu2.param2 = cmu2_op_max.execute((bit<16>)meta.cmu_group8.cmu2.key[15:0]);
    }

    //action op_cmu2_reserved(){
    //    meta.cmu_group8.cmu2.param2 = cmu2_op_reserved.execute((bit<16>)meta.cmu_group8.cmu2.key[15:0]);
    //}
    ...
    action op_cmu3_cond_add(){
        meta.cmu_group8.cmu3.param2 = cmu3_op_cond_add.execute((bit<16>)meta.cmu_group8.cmu3.key[15:0]);
    }
    action op_cmu3_and_or(){
        meta.cmu_group8.cmu3.param2 = cmu3_op_and_or.execute((bit<16>)meta.cmu_group8.cmu3.key[15:0]);
    }
    action op_cmu3_max(){
        meta.cmu_group8.cmu3.param2 = cmu3_op_max.execute((bit<16>)meta.cmu_group8.cmu3.key[15:0]);
    }

    //action op_cmu3_reserved(){
    //    meta.cmu_group8.cmu3.param2 = cmu3_op_reserved.execute((bit<16>)meta.cmu_group8.cmu3.key[15:0]);
    //}
                               ...
                               inout egress_metadata_t meta )
{
    ...
    action op_cmu1_cond_add(){
        meta.cmu_group9.cmu1.param2 = cmu1_op_cond_add.execute((bit<16>)meta.cmu_group9.cmu1.key[15:0]);
    }
    action op_cmu1_and_or(){
        meta.cmu_group9.cmu1.param2 = cmu1_op_and_or.execute((bit<16>)meta.cmu_group9.cmu1.key[15:0]);
    }
    action op_cmu1_max(){
        meta.cmu_group9.cmu1.param2 = cmu1_op_max.execute((bit<16>)meta.cmu_group9.cmu1.key[15:0]);
    }

    //action op_cmu1_reserved(){
    //    meta.cmu_group9.cmu1.param2 = cmu1_op_reserved.execute((bit<16>)meta.cmu_group9.cmu1.key[15:0]);
    //}
    ...
    action op_cmu2_cond_add(){
        meta.cmu_group9.cmu2.param2 = cmu2_op_cond_add.execute((bit<16>)meta.cmu_group9.cmu2.key[15:0]);
    }
    action op_cmu2_and_or(){
        meta.cmu_group9.cmu2.param2 = cmu2_op_and_or.execute((bit<16>)meta.cmu_group9.cmu2.key[15:0]);
    }
    action op_cmu2_max(){
        meta.cmu_group9.cmu2.param2 = cmu2_op_max.execute((bit<16>)meta.cmu_group9.cmu2.key[15:0]);
    }

    //action op_cmu2_reserved(){
    //    meta.cmu_group9.cmu2.param2 = cmu2_op_reserved.execute((bit<16>)meta.cmu_group9.cmu2.key[15:0]);
    //}
    ...
    action op_cmu3_cond_add(){
        meta.cmu_group9.cmu3.param2 = cmu3_op_cond_add.execute((bit<16>)meta.cmu_group9.cmu3.key[15:0]);
    }
    action op_cmu3_and_or(){
        meta.cmu_group9.cmu3.param2 = cmu3_op_and_or.execute((bit<16>)meta.cmu_group9.cmu3.key[15:0]);
    }
    action op_cmu3_max(){
        meta.cmu_group9.cmu3.param2 = cmu3_op_max.execute((bit<16>)meta.cmu_group9.cmu3.key[15:0]);
    }

    //action op_cmu3_reserved(){
    //    meta.cmu_group9.cmu3.param2 = cmu3_op_reserved.execute((bit<16>)meta.cmu_group9.cmu3.key[15:0]);
    //}
