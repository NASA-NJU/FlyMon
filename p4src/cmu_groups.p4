                               ...
                               inout egress_metadata_t meta )
{
    ...
    RegisterAction<bit<16>, bit<16>, bit<16>>(cmu2_buckets) cmu2_op_max_min = {
        void apply(inout bit<16> value, out bit<16> result) {
            result = 0;
            if(meta.cmu_group1.cmu2.param2 == 0 && value < meta.cmu_group1.cmu2.param1){
                value = meta.cmu_group1.cmu2.param1;
                result = value;
            }
            else if( meta.cmu_group1.cmu2.param2 == 1 && value > meta.cmu_group1.cmu2.param1){
                value = meta.cmu_group1.cmu2.param1;
                result = value;
            }
        }
    ...
    action op_cmu2_max_min(){
        meta.cmu_group1.cmu2.param2 = cmu2_op_max_min.execute((bit<16>)meta.cmu_group1.cmu2.key[4:0]);
    }
